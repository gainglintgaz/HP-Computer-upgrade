...
> Buy sooner rather than later — prices are expected to keep rising through 2027.

---

## PART 1: NVMe SSD — PURCHASED

> **BOUGHT: MSI SPATIUM M480 PRO PCIe 4.0 NVMe M.2 1TB — $140 at Walmart**
> See [SSD_INSTALL_GUIDE.md](SSD_INSTALL_GUIDE.md) for installation and Windows migration instructions.

Your HP supports PCIe 3.0 x4 NVMe. The M480 PRO will run at Gen 3 speeds (~3,500 MB/s max) in your system.
...
> [TechRadar — DDR4 Prices Rising](https://www.techradar.com/pro/is-ram-the-new-bitcoin-ddr4-memory-prices-are-rising-so-fast-some-tracker-graphs-are-running-out-of-space-and-i-fear-2026-could-well-see-a-10x-price-rise) |
> [WCCFTech Shortage Report](https://wccftech.com/memory-ddr5-ddr4-shortages-last-till-q4-2027-higher-prices-throughout-2026/)

### Buy DDR4-3200 Instead of DDR4-2666
...
- **DDR4-3200 auto-downclocks to 2666MHz in your HP** — no BIOS changes needed
- All kits listed are Non-ECC UDIMM 288-pin 1.2V — compatible with your HP
- **Compare prices across Amazon, Walmart, Best Buy, Newegg, and Micro Center** — even $10-20 savings helps
...
- Check [CamelCamelCamel](https://camelcamelcamel.com/product/B07RW6Z692) for Amazon price drop alerts
- Check [eBay](https://www.ebay.com/b/PC4-21300-DDR4-2666-Bus-Speed-DIMM-Computer-Memory-RAM-32-GB-Total-Capacity/170083/bn_113555812) for possible cheaper new/open-box kits

---

## PART 3: Where to Buy — Retailer Trust Rankings

| Rank | Retailer | Why Trust Them | Return Policy | Notes |
|------|----------|---------------|---------------|-------|
| 1 | **Amazon** | Largest selection, competitive prices, fast shipping | 30 days | Watch for 3rd-party sellers — buy "Ships from Amazon" |
| 2 | **Best Buy** | In-store pickup, price match guarantee | 15 days (60 for members) | Good for immediate needs |
| 3 | **Newegg** | PC parts specialist, frequent sales | 30 days | Check Newegg's 25th Anniversary Sale (active now) |
| 4 | **Micro Center** | Best in-store PC deals, knowledgeable staff | 30 days (15 for CPUs) | In-store only deals are often cheapest |
| 5 | **Crucial Direct** | Guaranteed compatibility, manufacturer | 45 days | Use their compatibility scanner tool |
| 6 | **B&H Photo** | No sales tax in most states, reliable | 30 days | Good alternative to Amazon |
| 7 | **Costco** | Extended warranty, easy returns | 90 days electronics | Membership required ($60/yr) |
| 8 | **Sam's Club** | Good bundle deals | 90 days electronics | Membership required ($50/yr) |
| 9 | **Walmart** | Price competitive, convenient | 30 days | Limited PC parts selection |

### Sources
- [Tom's Hardware — Best SSD Deals 2026](https://www.tomshardware.com/pc-components/ssds/best-ssd-deals)
- [Tom's Hardware — Best SSDs 2026](https://www.tomshardware.com/reviews/best-ssds,3891.html)
- [Tom's Hardware — SSD Price Tracking 2026](https://www.tomshardware.com/pc-components/ssds/ssd-price-tracking-2026-lowest-price-on-every-m-2-ssd)
- [Tom's Hardware — Best RAM 2026](https://www.tomshardware.com/reviews/best-ram,4057.html)
...
- [WCCFTech — Memory Shortages Through 2027](https://wccftech.com/memory-ddr5-ddr4-shortages-last-till-q4-2027-higher-prices-throughout-2026/)
- [Club386 — DDR4 RAM Prices Quadruple](https://www.club386.com/ddr4-ram-prices-quadruple/)
- [OriginalPricing — RAM Prices 2026 Crisis](https://originalpricing.com/ram-prices-2026-crisis-ddr5-ddr4-shortage/)
- [Pangoly — Crucial CT2K16G4DFRA266 Price History](https://pangoly.com/en/price-history/crucial-32gb-2-x-16gb-ddr4-2666-ct2k16g4dfra266)
- [Pangoly — Crucial CT2K16G4DFRA266 Price Comparison](https://pangoly.com/en/product/crucial-32gb-2-x-16gb-ddr4-2666-ct2k16g4dfra266)
- [Pangoly — Patriot Viper Elite II Price Comparison](https://pangoly.com/en/product/patriot-viper-elite-ii-32gb-2-x-16gb-ddr4-2666)
- [Slickdeals — SSD Deals](https://slickdeals.net/deals/ssd/)
- [GamesRadar — Best SSD Prices Feb 2026](https://www.gamesradar.com/hardware/best-ssd-prices-deals/)
- [BaCloud — When Will RAM Prices Go Down Jan 2026](https://www.bacloud.com/en/blog/246/when-will-ram-prices-go-down-market-update--january-2026.html)
- [TechRadar — DDR4 Prices Rising](https://www.techradar.com/pro/is-ram-the-new-bitcoin-ddr4-memory-prices-are-rising-so-fast-some-tracker-graphs-are-running-out-of-space-and-i-fear-2026-could-well-see-a-10x-price-rise)
